...
public class WeatherClient {
    ...
    public String getTodayWeather() {
        ...
        if (!HttpStatus.OK.equals(responseEntity.getStatusCode())) {
            throw new CustomException(ExceptionEnum.WEATHER_DATA_LOAD_FAILED,
                    ExceptionEnum.WEATHER_DATA_LOAD_FAILED.getMessage() + responseEntity.getStatusCode());
        }
        if (weatherArray == null || weatherArray.length == 0) {
            throw new CustomException(ExceptionEnum.NOT_FOUND_WEATHER);
        }
